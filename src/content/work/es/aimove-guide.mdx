...
<GenericCard
	...
	gridColumns={3}
	showIcons={true}
	photo={{ src: "/assets/Guide_Dark.webp", alt: "Plataforma de documentacion integral para la gestion de transporte y logistica con arquitectura multi-layout." }}
/>
...
<GenericCard
	...
	gridColumns={2}
	showIcons={true}
	photo={{ src: "/assets/Guide_Mobile_Dark.webp", alt: "Marco de documentación integral de la aplicación móvil Hub para la gestión de software de transporte y logística." }}
/>
