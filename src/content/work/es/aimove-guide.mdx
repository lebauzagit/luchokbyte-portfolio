...
<GenericCard
	...
	gridColumns={3}
	showIcons={true}
	photo={{ src: "/assets/User_Guide_Dark.webp", alt: "Comprehensive documentation framework for managing transportation and logistics software with multi-layout architecture." }}
/>
